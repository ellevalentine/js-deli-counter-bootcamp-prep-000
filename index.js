...
// This means that the conditoin of the while loop implie: "i" must always be less than the lenth of the katzDeli line. since if the line is not greater than 1 then its equal to 0 (hence the line is empty).
// and if the line is empty then we want the functoin to print the sting: ""
